...
$customCss = "Assets/css/booking.css";
...
// Check if this file is being included by another file
$isIncluded = isset($headless) && $headless === true;

// If not included, include the header
if (!$isIncluded) {
    include('header.php');
}
?>
...
<?php
// If not included, include the footer
if (!$isIncluded) {
    include('includes/footer.php');
    
    // Add booking.js script
    echo '<script src="Assets/js/booking.js"></script>';
...
// Add event listeners to update booking summary when inputs change
