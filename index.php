...
<body>
    ...
    <main>
        <div class="intro">
            ...
            <p class="bio">Bienvenue sur Bayatni.tn,</br>Votre plateforme de réservation d’agenda en ligne dédiée aux hôtels en Tunisie.</br></p>
        </div>
        <a href="booking.html"><button class="widget-btn">Réserver</button></a>
