            ...
            <div class="dashboard-content" id="dashboard">
                ...
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <a href="/bayatni/admin/app/controllers/bookings/bookings.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="/bayatni/admin/app/controllers/bookings/booking_view.php?id=<?php echo $booking['id']; ?>" class="action-btn view-btn"><i class="fas fa-eye"></i></a>
                                            <a href="/bayatni/admin/app/controllers//bookings/booking_edit.php?id=<?php echo $booking['id']; ?>" class="action-btn edit-btn"><i class="fas fa-edit"></i></a>
                                            <a href="/bayatni/admin/app/controllers/bookings/bookings.php?action=delete&id=<?php echo $booking['id']; ?>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this booking?');"><i class="fas fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                ...
                <div class="recent-reviews">
                    <div class="section-header">
                        ...
                        <a href="/bayatni/admin/app/controllers/reviews/reviews.php" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                    </div>
