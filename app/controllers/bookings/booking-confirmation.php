            ...
            <div class="max-w-2xl mx-auto">
                <div class="glass-card rounded-xl p-8">
                    ...
                    <div class="text-center space-x-4">
                        <a href="/production/public/index.php" class="inline-block px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition shadow-lg hover:shadow-xl">
