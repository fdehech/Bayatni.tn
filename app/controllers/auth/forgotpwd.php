    ...
    if (isset($_POST['recover']) && !empty($_POST['email'])) {
        ...
        if ($user) {
            ...
            try {
                ...
                $resetLink = 'http://localhost/bayatni/app/auth/resetpwd.php?token=' . urlencode($token);
...
<head>
  ...
  <link rel="stylesheet" href="/bayatni/public/css/index.css">
  <link rel="stylesheet" href="/bayatni/public/css/pwd.css"> 
