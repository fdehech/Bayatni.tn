                ...
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <form method="POST" action="/bayatni/app/controllers/bookings/process_booking.php" id="booking-form">
                                ...
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <div class="p-6 flex-1 flex flex-col justify-between">
                                        ...
                                        <div class="mt-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                                            <a href="/bayatni/app/views/hotel-details.php?id=${hotel.id}" class="px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-lg hover:bg-white/30 transition text-center">
