...
// Function to get booking status class
...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?auto=format&fit=crop&w=1920&q=80');
...
<body class="min-h-screen text-gray-800">
    ...
    <!-- Footer -->
    <footer class="py-8 px-4 sm:px-6 lg:px-8 text-center text-white">
        <div class="container mx-auto">
            <p class="mb-4">&copy; 2023 Bayatni.tn - Tous droits réservés</p>
            <div class="flex justify-center space-x-6">
                <a href="#" class="text-white hover:text-primary-300 transition"><i class="fab fa-facebook-f"></i></a>
                <a href="#" class="text-white hover:text-primary-300 transition"><i class="fab fa-instagram"></i></a>
                <a href="#" class="text-white hover:text-primary-300 transition"><i class="fab fa-twitter"></i></a>
            </div>
        </div>
    </footer>
